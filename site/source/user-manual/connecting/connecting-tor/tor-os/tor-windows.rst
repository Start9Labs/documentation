...
#. Once you have selected a language, you should see a menu like this:
   ...
   We will install it to ``C:\Program Files\Tor Brwoser``.  If you choose a different folder, it needs to *not* be anywhere under ``C:\Users\``.  Note the path you use here for the step after next.
